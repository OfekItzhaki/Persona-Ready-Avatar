 ...
 * Design Token Values
 * 
 * This module defines the actual values for all design tokens.
 * These tokens are used across the application to ensure visual consistency.
 * 
...
/**
 * Core design tokens
 * These values are theme-independent and provide the foundation for the design system
 */
export const designTokens: DesignTokens = {
  ...
  typography: {
    fontFamily: {
      ...
      mono: '"Fira Code", "Cascadia Code", "Courier New", Courier, monospace',
